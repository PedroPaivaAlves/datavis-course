function Network() {
  ...
  function setupData(data) {
    ...
    l.target = nodesMap.get(l.target);
      ...
      (l.source.connections === undefined) ? l.source.connections = 1 : l.source.connections++ ;
      (l.target.connections === undefined) ? l.target.connections = 1 : l.target.connections++ ;
    ...
    data.nodes.forEach(function(n) {
      ...
      n.radius = circleRadius(n.connections);
    });
  ...
  function showDetails(d, i) {
    ...
    content += '<p class="main">' + d.connections + '</span></p>';
  ...
  network = function(selection, data) {
    ...
    updateLinks();
    // set the tick callback, charge and linkDistance
    force.on("tick", forceTick).charge(-350).linkDistance(100);
